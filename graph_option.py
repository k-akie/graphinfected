...
emergency_term = [  # 緊急事態宣言
    [dt.fromisoformat('2020-04-07'), dt.fromisoformat('2020-05-21'), '緊急事態宣言'],  # 1回目
...
semi_emergency_term = [  # まん延防止等重点措置
    [dt.fromisoformat('2021-04-05'), dt.fromisoformat('2021-04-24'), 'まん延防止等重点措置'],  # 1回目、3回目の緊急事態宣言に変わった
