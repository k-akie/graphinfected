...
if __name__ == '__main__':
    ...
    # 出力(割合)
    make_output_ratio(generation_dict, population, infected, osaka.name, Grouping.MALE)
    make_output_ratio(generation_dict, population, infected, osaka.name, Grouping.FEMALE)
    make_output_ratio(generation_dict, population, infected, osaka.name, Grouping.ALL)

    # 出力(生値)
    make_output_row(generation_dict, population, infected, osaka.name, Grouping.MALE)
    make_output_row(generation_dict, population, infected, osaka.name, Grouping.FEMALE)
    make_output_row(generation_dict, population, infected, osaka.name, Grouping.ALL)
